{{ config(enabled=(var('rag__using_hubspot', True) and var('rag_hubspot_sales_enabled', True) and var('rag_hubspot_engagement_enabled', True) and var('rag_hubspot_engagement_email_enabled', True))) }}
