...
{% set base_table = ref('stg_rag_hubspot__engagement_note_base') if var('rag_hubspot_union_schemas', []) != [] or var('rag_hubspot_union_databases', []) != [] else source('rag_hubspot', 'engagement_note') %}
